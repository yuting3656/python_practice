...
image = face_recognition.load_image_file("kkk.jpg")
...
for face_landmarks in face_landmarks_list:
    ...
    d.line(face_landmarks['left_eyebrow'], fill=(128, 128, 128), width=10)
    d.line(face_landmarks['right_eyebrow'], fill=(128, 128, 128), width=10)
